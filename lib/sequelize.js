...
class Sequelize {
   ...
   *
   *   // use '->', '->>' operator for access JSON, JSONB fields
   *   // instead of '#>', '#>>' in case of pg
   *   // - defalut: false
   *   useOtherJsonAccessOperator: true
   * })
   *
   ...
   * @param {boolean}  [options.useOtherJsonAccessOperator=false] A flag that defines if show bind patameters in log.
   */
  constructor(database, username, password, options) {
    ...
    this.options = Object.assign({
      ...
      useOtherJsonAccessOperator: false
    }, options || {});
